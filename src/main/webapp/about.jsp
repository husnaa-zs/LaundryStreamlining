        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 pl-lg-5">
                    ...
                    <h5 class="font-weight-medium font-italic mb-4">Revolutionizing the way you approach laundry, our innovative system blends cutting-edge technology with eco-friendly practices, ensuring a seamless, efficient, and sustainable experience</h5>
                    <p class="mb-2">Laundry redefined: convenience at its finest.</p>
                    <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 m-0 my-lg-5 pt-0 pt-lg-5 pr-lg-5">
                    ...
                    <p>Choose us for an unparalleled laundry experience marked by cutting-edge technology, unmatched efficiency, and a commitment to sustainability.</p>
                    <div class="row">
