<%-- 
    ...
    Created on : 29 Jun 2024, 12:15:10 pm
    Author     : husna
--%>
...
<html>
    <head>
        ...
        <style>
            .navbar {
                background-color: #333; /* This sets the background color to dark grey */
                color: white; /* This sets the text color to white */
            }

            .card, .card-body {
                height: 100%; /* Make sure the card and its body take up the full height */
            }
            .card-body {
                padding: 0; /* Remove padding to ensure the image covers the entire card body */
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index_1.html">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost:8088/LaundryStreamlining/list">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>Delivery List</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost:8088/LaundryStreamlining//BookingListServlet">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>Delivery Process</span></a>
                </li>
                <!-- Divider -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="container-fluid h-100">
                            ...
                            <div class="container-fluid pt-1" style="max-width: 100%;">
                                <a href="#" class="logo">
                                    <img src="img/D4.gif" class="w-100 img-fluid" alt="Feedback image">
                                    <a href="DeliveryForm.jsp" class="btn btn-white">Go to Delivery Form</a>
